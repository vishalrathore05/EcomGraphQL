...
class GraphqlController < ApplicationController
  ...
  def execute
    ...
    result = EcomApiSchema.execute(query, variables: variables, context: context, operation_name: operation_name)
    render json: result
  ...
  def current_user_from_token
    ...
    if RevokedToken.exists?(token: token)
      raise GraphQL::ExecutionError, "Token has been revoked"
    end
